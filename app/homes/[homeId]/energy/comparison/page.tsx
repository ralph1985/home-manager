...
import EnergyComparisonSection from "@/components/billing/EnergyComparisonSection";
...
export default async function EnergyComparisonPage({
  ...
  return (
    <PageShell>
      ...
      <EnergyComparisonSection labels={labels} comparison={comparison} homeId={home.id} />
    </PageShell>
  );
}
