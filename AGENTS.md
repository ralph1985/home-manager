...
- El backup y los snapshots ejecutan el sync a OneDrive si `projects/onedrive-file-sync/run.sh` está disponible (puedes desactivarlo con `SKIP_ONEDRIVE_SYNC=1`).
